"""
Django settings for late_hill_42231 project.
...
ROOT_URLCONF = 'late_hill_42231.urls'
...
WSGI_APPLICATION = 'late_hill_42231.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "late_hill_42231 API",
    "DESCRIPTION": "API documentation for late_hill_42231 App",
    "VERSION": "v1",
}
